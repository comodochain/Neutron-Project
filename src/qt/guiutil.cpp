...
=======
    // return if URI is not valid or is no bitcoin URI
    if(!uri.isValid() || uri.scheme() != QString("neutroncoin"))
>>>>>>> 0.8
        return false;
...
=======
    ...
    if(uri.startsWith("neutroncoin://"))
    {
        uri.replace(0, 11, "neutroncoin:");
    }
>>>>>>> 0.8
...
=======
    return GetSpecialFolderPath(CSIDL_STARTUP) / "Neutroncoin.lnk";
>>>>>>> 0.8
}
...
=======
    return GetAutostartDir() / "neutroncoin.desktop";
>>>>>>> 0.8
}
...
<<<<<<< HEAD
    ...
    QApplication::clipboard()->setText(str, QClipboard::Selection);
=======
    header = tr("Neutroncoin-Qt") + " " + tr("version") + " " +
        QString::fromStdString(FormatFullVersion()) + "\n\n" +
        tr("Usage:") + "\n" +
        "  neutroncoin-qt [" + tr("command-line options") + "]                     " + "\n";
    ...
    setWindowTitle(tr("Neutroncoin-Qt"));
